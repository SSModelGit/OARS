...
model Spanker
  parameter Modelica.Mechanics.MultiBody.Types.Axis mastAxis = {0, 1, 0};
  extends OARS.Components.Templates.SailWithMount(servoJoint.n = mastAxis, servoJoint.useAxisFlange = true, servo.useSupport = true, servoMount.n = mastAxis);
equation
